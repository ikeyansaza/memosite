...
<?php require('header.php'); ?>
    ...
    <div id="contents" class="site-width">
      ...
      <section id="main">
        <div class="rule">
        <h2>プライバシーポリシー</h2>
          　メモサイト運営（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          <br><br>
          <h2>第1条（個人情報）</h2>
          ...
          <h2>第6条（個人情報の開示）</h2>
          　当社は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。なお，個人情報の開示に際しては，1件あたり1，000円の手数料を申し受けます。<br><br>
          ...
          <br>
          <br>
          Eメールアドレス：memosite@memosite.xyz
          <br><br>
          以上
          <br><br>
        </div>
